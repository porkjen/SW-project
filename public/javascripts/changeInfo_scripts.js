...
const firstPreBtn = document.querySelector("preBtn-1");
const secNextBtn = document.querySelector("nextBtn-1");
const secPreBtn = document.querySelector("preBtn-2");
const thirdNextBtn = document.querySelector("nextBtn-2");
const thirdPreBtn = document.querySelector("preBtn-3");
